...
class DetailPasienScreen extends StatelessWidget {
          ...
          children: [
            ...
            Table(
              border: TableBorder.symmetric(
                inside:
                    BorderSide(color: Colors.black, width: 1), // Garis dalam
                outside: BorderSide(
                    color: Colors.black,
                    width: 1), // Garis luar, termasuk tepi kanan
              ),
              columnWidths: const {
                0: FlexColumnWidth(1),
                1: FlexColumnWidth(1),
            ...
            ElevatedButton.icon(
              onPressed: () {
                _generateAndOpenPdf(
                    context); // Panggil fungsi generate dan buka PDF
              },
    ...
    pdf.addPage(
      pw.Page(
        build: (pw.Context context) => pw.Column(
          ...
          children: [
            pw.Text('Detail Cek Laboratorium',
                style:
  ...
  // Fungsi untuk membuat item detail di PDF
